...
//            Log.e(TAG, list.size() + "");
            ...
            storageAdapter = new StorageAdapter(this, list);
            storageAdapter.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(View view, int position) {
                    ...
                    intent.setClass(StorageListActivity.this, StorageDetailActivity.class);
    ...
    private void loadFail(String message) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                LoadingDialog.cancelDialogForLoading();
                Toasts.showShort(StorageListActivity.this, message);
            }
        });
    }
