...
public class TotalCheckAdapter extends RecyclerView.Adapter<TotalCheckAdapter.VH> {
    Context context;
    List<StorageListOrder> list;

    public TotalCheckAdapter(Context context, List<StorageListOrder> list) {
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_total_check, parent, false);
        return new VH(view);
    }
